...
%       desc: directory of lsf file to open
    ...
    methods
        ...
        function obj = setexpansion( obj, name, monitor_name )
            % Associates a DFT monitor with a mode expansion monitor.
            % see: https://kb.lumerical.com/en/ref_scripts_addmodeexpansion.html
            %      https://kb.lumerical.com/en/ref_scripts_setexpansion.html
            %
            % Requires that the mode expansion monitor is already selected
            %
            % Inputs:
            %   name
            %       type: string
            %       desc: name that the mode expansion monitor uses, can be
            %             any thing
            %   monitor_name
            %       type: string
            %       desc: name of DFT monitor to add. must exist in the
            %             lumerical model workspace
            %
            % Example:
