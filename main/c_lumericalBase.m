    ...
    methods
        ...
        function obj = setprop(obj, prop_name, prop_val)
            ...
            if ischar(prop_val)
                ...
                obj = obj.write_command( [ 'set(''' prop_name ''', ' regexprep( mat2str(prop_val, 10), {'\s+'}, {','} ) ');' ] ); 
            end
        ...
        function [ obj, data ] = appgetvar_dataset( obj, var_name )
            ...
            obj = obj.save_var_to_mat( 'temp_varfile.mat', var_name );
            obj = obj.execute_commands();
            
            % load .mat file
            data = load( 'temp_varfile.mat' );
            
            % delete the temporary mat file
            delete temp_varfile.mat;
